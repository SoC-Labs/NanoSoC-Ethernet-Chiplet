...
def selftest():
    """Both directions. A hash that ignores timestamps is only useful if it
    still notices geometry -- a canonicaliser that returns a constant would
    pass every same-layout test ever written."""
    import tempfile
    ok = True
