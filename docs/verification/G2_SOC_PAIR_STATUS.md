...
* reuses the proven `dph_peer`/`hready_to_peer` fix (`../design/D2D_HREADY_LOOP.md`) —
...
`hready_to_peer = dph_peer ? 1'b1 : …` fix (../design/D2D_HREADY_LOOP.md, added to break
...
| `G2_SOC_PAIR_STATUS.md` | this file |
