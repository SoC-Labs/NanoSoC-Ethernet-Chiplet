...
Source of truth: [`ASIC/genus-innovus/scripts/floorplan.tcl`](../../ASIC/genus-innovus/scripts/floorplan.tcl).
Sourced by [`2_pnr_setup.tcl`](../../ASIC/asic-flows/Cadence/2_pnr_setup.tcl) immediately after `commit_power_intent`, and immediately before [`power_plan.tcl`](../../ASIC/genus-innovus/scripts/power_plan.tcl). That ordering is load-bearing — see [Publishing the resolved macro list](#publishing-the-resolved-macro-list).
...
| Bond pads | 42 × `PAD70GU` (outer) + 40 × `PAD70NU` (inner) = 82 | [`place_bondpads.tcl`](../../ASIC/genus-innovus/scripts/place_bondpads.tcl) |
...
[`place_bondpads.tcl`](../../ASIC/genus-innovus/scripts/place_bondpads.tcl) with
...
[`nanosoc_eth_chiplet_pads.io`](../../ASIC/genus-innovus/scripts/nanosoc_eth_chiplet_pads.io) is
...
[`place_bondpads.tcl`](../../ASIC/genus-innovus/scripts/place_bondpads.tcl), sourced by
...
[`probe_macros.tcl`](../../ASIC/genus-innovus/scripts/probe_macros.tcl), which replicates
