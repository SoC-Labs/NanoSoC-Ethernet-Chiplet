...
`../debug/DIAGNOSE_XHB500_RAW_HREADYOUT_LOW.md`: the XHB500 RESP FSM combinationally forces
...
Plan: `../bringup/HW_VALIDATION_PLAN_TL042_V2.md`; the turnkey harness is delivered under `scripts/rig/`
...
## 6. See also
- `../debug/DIAGNOSE_HREADYOUT_LOW_u_xhb_sub.md` — the wr_hold wedge handback (round-2 resolution).
- `../debug/DIAGNOSE_XHB500_RAW_HREADYOUT_LOW.md` — the raw co-hold characterization (in progress).
- `../bringup/HW_VALIDATION_PLAN_TL042_V2.md` — the v2 no-harm campaign design.
