...
> **RESOLVED — do not act on the recommendation below.** Measured 2026-07-30. The
> regression was root-caused on 2026-07-31 to two bring-up *sequencing* bugs, not a
> timing or footprint effect, and the pair now brings up with the recovery FCSM in
> place (no `deps` revert). See `I1_RESOLVED_HANDOVER_2026_07_31.md`. Kept for the
> silicon measurements and the elimination argument.
