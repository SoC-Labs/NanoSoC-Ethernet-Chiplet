...
Companion to `../verification/SYSTEM_VALIDATION_HOLES_REPORT_2026-08-08.md`, `HW_LOOP_RESULTS_2026-08-08.md`,
`../verification/SYSVAL_TEST_BUILD_SPEC_2026-08-08.md`. Principle: **unblock the root blockers, not the tests
...
- **E — Firmware UPGRADE:** on-die **CPU0** M0 firmware likely runs on the **current bits, no rebuild**
  ...
  ISR path = CPU0 mailbox slot1 (not CPU1). Design: `../design/FIRMWARE_ENABLE_DESIGN_2026-08-08.md`.
