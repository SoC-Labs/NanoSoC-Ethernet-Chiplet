...
- **Residual (bounded).** The preloaded IMEM **app never executes its first
  ...
  `cpu0-firmware-backdoor-preload`. Design doc: `../design/FIRMWARE_ENABLE_DESIGN_2026-08-08.md`.
...
| Doc | What it covers |
|---|---|
| `../verification/SYSTEM_VALIDATION_HOLES_REPORT_2026-08-08.md` | 5-agent audit: only cross-die WRITE is genuinely validated; reads/PTP/TideChart/ethernet/M0-firmware untested; false-greens catalogued |
| `../verification/SYSVAL_TEST_BUILD_SPEC_2026-08-08.md` | build spec for the sysval suite |
...
| `../design/FIRMWARE_ENABLE_DESIGN_2026-08-08.md` | CPU0 firmware enable design (backdoor preload + gate release) |
...
`../design/FIRMWARE_ENABLE_DESIGN_2026-08-08.md`.)
