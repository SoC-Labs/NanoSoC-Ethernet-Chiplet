...
Follow-on to `../verification/SYSTEM_VALIDATION_HOLES_REPORT_2026-08-08.md` (the holes) and
`../verification/SYSVAL_TEST_BUILD_SPEC_2026-08-08.md` (the 8-agent build spec). This records what was
