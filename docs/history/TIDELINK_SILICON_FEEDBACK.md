...
Full root-cause analysis: `../debug/CROSS_DIE_WEDGE_ROOTCAUSE.md` (in the eth-chiplet repo).
...
> Full evidence, ruled-out alternatives, and RTL hypothesis: **`I1_FCSM_BRINGUP_REGRESSION.md`**.
...
`../verification/TIDECHART_TEST_PLAN.md`.
...
- Consumer analysis + tools (eth-chiplet repo): `../debug/CROSS_DIE_WEDGE_ROOTCAUSE.md`,
  `../design/CROSS_DIE_INTERRUPTS.md`, `../design/CROSS_DIE_DEBUG_PLAN.md`,
