...
plan section of `docs/FULL_LINT_FINDINGS.md`, which contained three errors — see
§0.**
...
Three P1 items in `docs/FULL_LINT_FINDINGS.md` were wrong. Two would have caused
...
> Also: `docs/CDC_FINDINGS.md` claims HAL cannot do a full `CLKDMN` analysis
