...
`docs/SYSTEM_APP_TRANSPARENT_BRIDGE.md:97-110`, `docs/CROSS_DIE_INTERRUPTS.md:33-36`,
`docs/CROSS_DIE_TEST_BACKLOG.md:26,44-46`,
...
Goal (backlog #8, `CROSS_DIE_TEST_BACKLOG.md:26`;
...
(`RULE_0=0x00232F01`, `CROSS_DIE_TEST_BACKLOG.md:19`); the near die reads
...
- **Host tooling:** a small extension of the existing PS backdoor scripts
  ...
  a new hard-coded script (`CROSS_DIE_TEST_BACKLOG.md:48-52`). Owner: host tooling.
