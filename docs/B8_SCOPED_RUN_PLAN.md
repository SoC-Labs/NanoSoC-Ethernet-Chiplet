...
**Predecessors:** `docs/CDC_B7_BASELINE.md`, `docs/CDC_B7_ROUND2.md` (neither modified)
...
undeclared clock, which it will either infer or default. Per `docs/CDC_B7_BASELINE.md` §1,
...
**Do not delete §7a.** `docs/CDC_B7_ROUND2.md` §4d turns on it: findings 32/33
...
contains zero `waive` statements and `docs/CDC_B7_ROUND2.md` §1 keeps it that way on
...
# docs/B8_SCOPED_RUN_PLAN.md section 6 / docs/tapeout/24 section 7.2.
