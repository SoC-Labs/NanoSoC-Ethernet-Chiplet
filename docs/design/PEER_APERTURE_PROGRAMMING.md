...
**This collides with the G2 plan.** `../verification/G2_PAIR_SIM.md:23-27` asserts *both*
...
literally as `../verification/G2_PAIR_SIM.md` states today.
...
3. **The IPC-mailbox reachability decision (§5) is unresolved at the chiplet
   ...
   and the text of `../verification/G2_PAIR_SIM.md` assertion 2. This needs an owner decision,
