...
`../bringup/CROSS_DIE_TEST_BACKLOG.md`, `PEER_APERTURE_PROGRAMMING.md`,
`CROSS_DIE_INTERRUPTS.md`, `CHIPLET_ALIGNMENT.md`,
`../debug/CROSS_DIE_WEDGE_ROOTCAUSE.md`, `../history/PROPOSAL_AUTO_ANCHOR_RTL_2026_08_04.md`,
...
**Two physically distinct link transports** (`../debug/CROSS_DIE_WEDGE_ROOTCAUSE.md`):
