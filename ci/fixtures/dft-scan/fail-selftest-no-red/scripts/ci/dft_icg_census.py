...
transcript that is the real one with ONE mutation:
  ...
  all five cases now expect exit 0. The battery still runs five cases and
  still reports them all `ok`, and it no longer demonstrates that the
  detector can say no to anything.
