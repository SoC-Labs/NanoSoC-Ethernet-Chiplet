...
//
// MUTATION APPLIED HERE: one pad instance (uPAD_RMII_MDC) deleted. 34 supply pads were once
// silently dropped this way; the boundary register can be perfectly
// intact while the ring it observes is not.
// -----------------------------------------------------------------------------
