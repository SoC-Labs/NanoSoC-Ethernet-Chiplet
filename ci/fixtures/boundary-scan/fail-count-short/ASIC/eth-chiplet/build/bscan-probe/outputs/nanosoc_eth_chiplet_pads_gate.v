...
//
// MUTATION APPLIED HERE: 126 of the 166 sequential cells deleted, leaving 40 -- fewer than the
// 76 boundary cells the pad table declares. This is the shape of a
// register whose shift path was broken partway along, so the stages
// downstream of the break became unobservable and were swept.
// -----------------------------------------------------------------------------
